  ...
  const loadUserProfile = useCallback(async () => {
    ...
    try {
      ...
      if (data) {
        ...
        console.log('Profile (iOS): Loaded loyalty_points:', balance, 'loyalty_level (DB):', (data as any).loyalty_level ?? 'null (will use fallback)');
      } else {
            ...
            {loadingPoints ? (
              ...
              <View style={styles.pickupPointRow}>
                ...
                <Pressable
                  ...
                  onPress={() => {
                    console.log('Profile (iOS): User tapped Cambia punto di ritiro');
          ...
          >
            <SafeAreaView style={styles.modalContainer} edges={['top', 'bottom']}>
              <View style={styles.modalHeader}>
                ...
                <Pressable
                  onPress={() => {
                    console.log('Profile (iOS): User closed pickup modal');
              ...
              <ScrollView contentContainerStyle={styles.modalList}>
                {pickupPoints.map((point) => (
                  <Pressable
                    ...
                    onPress={async () => {
                      console.log('Profile (iOS): User selected pickup point in modal:', point.city);
