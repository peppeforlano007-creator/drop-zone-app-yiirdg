...
export type Database = {
  public: {
    ...
    Functions: {
      ...
      check_underfunded_drops: { Args: Record<string, never>; Returns: undefined }
      complete_drop: { Args: { p_drop_id: string }; Returns: undefined }
      expire_old_drops: { Args: Record<string, never>; Returns: undefined }
      ...
      get_user_pickup_point_id: { Args: Record<string, never>; Returns: string }
      handle_item_return: {
        Args: {
      ...
      is_pickup_point: { Args: Record<string, never>; Returns: boolean }
      ...
      process_drop_lifecycle: { Args: Record<string, never>; Returns: undefined }
      ...
      release_underfunded_drop_funds:
        | { Args: Record<string, never>; Returns: undefined }
        | {
